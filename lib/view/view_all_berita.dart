...
import 'package:reworkmobile/widgets/berita_detail.dart'; // Pastikan ini sudah diimport
...
class _AllBeritaPageState extends State<AllBeritaPage> {
  ...
  List<dynamic> _allBerita = []; // Menyimpan semua data berita
  List<dynamic> _filteredBerita = []; // Data yang sudah difilter
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => const ViewAddBeritaPage()),
          );
        },
